...
const ShowEvent = () => {
    ...
    useEffect(() => {
        const fetchEvent = async () => {
            const response = await axios.get(`https://event-management-mofb.vercel.app/api/v1/event/show/${id}`, {
    ...
    useEffect(() => {
        const fetchAttendees = async () => {
            const response = await axios.get(`https://event-management-mofb.vercel.app/api/v1/attendee/${id}/allattendees`, {
                withCredentials: true,
                headers: {
                    "Content-Type": "application/json"
                }
    ...
    const deleteEvent = async () => {
        try {
            await axios.delete(`https://event-management-mofb.vercel.app/api/v1/event/delete/${id}`, {
                withCredentials: true,
                headers: {
                    "Content-Type": "application/json"
                },
