...
const Attendees = () => {
  ...
  const navigateTo = useNavigate();
    ...
    useEffect(()=>{
    const fetch = async ()=>{
        const response = await axios.get(`https://event-management-mofb.vercel.app/api/v1/attendee/${id}/${taskid}/allattendees`,{
  ...
  const handleAddAttendee = async (e) => {
    e.preventDefault();
    try {
       await axios.post(`https://event-management-mofb.vercel.app/api/v1/attendee/${id}/${taskid}/create`,
        {
          name:newAttendee
        },{
          withCredentials:true,
  ...
  const handleRemoveAttendee = async(index) => {
    try {
      await axios.delete(`https://event-management-mofb.vercel.app/api/v1/attendee/${id}/${taskid}/delete/${index}`,{
        withCredentials:true,
        headers:{
          "Content-Type":"application/json"
        }
